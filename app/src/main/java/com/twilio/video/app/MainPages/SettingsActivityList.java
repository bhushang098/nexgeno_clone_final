...
import com.twilio.video.app.SettingPages.AccountSettingsPage;
import com.twilio.video.app.SettingPages.HrSettingPage;
import com.twilio.video.app.SettingPages.PassSettingPage;
import com.twilio.video.app.SettingPages.RoleSetingsPage;
import com.twilio.video.app.SettingPages.UserNameSettingsPage;
...
public class SettingsActivityList extends AppCompatActivity {
    LinearLayout goAccnt,gouName,goRole,goPasss,gohr;
    ImageView ibBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gohr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(userObj.getIs_hr()==null)
                {
                    Toast.makeText(SettingsActivityList.this, "Something Went Wrong please Retry", Toast.LENGTH_SHORT).show();
                }else {
                    Intent i = new Intent(SettingsActivityList.this, HrSettingPage.class);
                    i.putExtra("status",userObj.getIs_hr().toString());
                    startActivity(i);
                }
    ...
    private void setUi() {
        ...
        gohr   = findViewById(R.id.lin_lay_go_hr_settings);
